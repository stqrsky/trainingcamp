<!-- <nav class="justify-content-center navbar fixed-bottom navbar-dark bg-dark">
    <div class="footer sticky-bottom bg-dark container-fluid">
        <div class="nav__button nav__button--index nbi"><a href="#home"><img src="/img/house.png" width=40px; alt=""></div>
        <div class="nav__button nav__button--create nbc"><a href="#schedule"><img src="/img/edit.png" width=40px; alt=""></div>
        <div class="nav__button nav__button--profile nbp"><a href="#athletes"><img src="/img/user.png" width=40px; alt=""></div>
        <div class="nav__button nav__button--settings nbs"><a href="#settings"><img src="/img/settings.png" width=40px; alt=""></div>
    </div>
</nav> -->

<!-- //Nav Trans -->
<div class="nav-section">
    <nav class="row stick-bottom justify-content-center fixed-bottom bg-dark">
        <ul class="andreas">
